...
BOT_NAME = "MACD + ADX30 + Histogram Rising Validation"
...
def generate_signals(
    ...
    # ==========================================================
    # HISTOGRAM RISING FILTER
    # ==========================================================

    if use_histogram_rising:
...
def print_parts(
    ...
    for part in range(4):
        ...
        if result is None:
            ...
            print(
                "P{} | Trades {} | WR {:.2f}% | PF {:.2f} | Balance {:+.2f} | DD {:.2f} | Streak {}".format(
                    part + 1,
                    result["trades"],
                    result["win_rate"] * 100,
...
def main():
    ...
    print(
        "3. MACD CALL + ADX >= 30 + Histogram Rising"
    )
